...
namespace CourseProject.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        {
            var dBContext = _context.Employee.Include(e => e.Manager).Include(e => e.Organization);
        ...
        public IActionResult Create()
        {
            ...
            ViewData["OrganizationId"] = new SelectList(_context.Set<Organization>(), "OrganizationId", "OrganizationId");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("EmployeeId,ManagerId,JobTitle,EmploymentType,PayRate,Availability,HoursWorked,Certifications,OrganizationId,Name,DetailsJson")] Employee employee)
        {
            ...
            ViewData["OrganizationId"] = new SelectList(_context.Set<Organization>(), "OrganizationId", "OrganizationId", employee.OrganizationId);
            return View(employee);
        }
